...
import { Icon } from "@/components/ui-reusables/icon"
import { NativeOnlyAnimatedView } from "@/components/ui-reusables/native-only-animated-view"
...
function DialogTitle({ className, ...props }: React.ComponentProps<typeof DialogPrimitive.Title>) {
  return (
    <DialogPrimitive.Title
      className={cn("text-foreground text-lg font-bold leading-none", className)}
      {...props}
    />
  )
}
