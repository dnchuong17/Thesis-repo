...
export function Header(props: HeaderProps) {
  ...
  const {
    backgroundColor = isDark ? colors.headerGlass : colors.surfaceBackdrop,
    LeftActionComponent,
    leftIcon,
    leftIconColor,
    leftText,
  ...
  return (
    <View
      style={[themed($container), $containerInsets, { backgroundColor }, $containerStyleOverride]}
    >
      <View style={[$styles.row, $wrapper, $styleOverride]}>
        <HeaderAction
          ...
          text={leftText}
          icon={leftIcon}
          iconColor={leftIconColor || (isDark ? colors.buttonPrimaryDark : colors.buttonPrimary)}
          onPress={onLeftPress}
        ...
        {!!titleContent && (
          ...
          >
            <Text text={titleContent} style={themed([$title, $titleStyleOverride])} />
          </View>
        )}
        ...
        <HeaderAction
          ...
          text={rightText}
          icon={rightIcon}
          iconColor={rightIconColor || (isDark ? colors.buttonPrimaryDark : colors.buttonPrimary)}
  ...
  if (content) {
    return (
      <TouchableOpacity
        ...
        activeOpacity={0.8}
      >
        <Text text={content} style={themed($actionText)} />
      </TouchableOpacity>
    )
  }
...
const $actionIconContainer: ThemedStyle<ViewStyle> = ({ colors, spacing }) => ({
  flexGrow: 0,
  alignItems: "center",
  justifyContent: "center",
  minWidth: 44,
...
const $titleWrapperCenter: ThemedStyle<ViewStyle> = ({ spacing }) => ({
  ...
  width: "100%",
  position: "absolute",
  paddingHorizontal: spacing.xxl, // Ensuring title doesn't overlap actions
  zIndex: 1,
})
