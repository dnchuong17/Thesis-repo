...
export const ThemeProvider: FC<PropsWithChildren<ThemeProviderProps>> = ({
  ...
  const [themeScheme, setThemeScheme] = useState<string | undefined>(
    loadString("ignite.themeScheme") ?? undefined,
  )
  ...
  const navigationTheme: NavTheme = useMemo(() => {
    ...
    return {
      ...
      colors: {
        ...baseTheme.colors,
        background:
          themeContext === "dark" ? darkTheme.colors.background : lightTheme.colors.background,
        border: themeContext === "dark" ? darkTheme.colors.border : lightTheme.colors.border,
        card: themeContext === "dark" ? darkTheme.colors.surface : lightTheme.colors.surface,
        notification: themeContext === "dark" ? darkTheme.colors.error : lightTheme.colors.error,
        primary: themeContext === "dark" ? darkTheme.colors.tint : lightTheme.colors.tint,
        text:
          themeContext === "dark" ? darkTheme.colors.textPrimary : lightTheme.colors.textPrimary,
      },
    }
  }, [themeContext])
